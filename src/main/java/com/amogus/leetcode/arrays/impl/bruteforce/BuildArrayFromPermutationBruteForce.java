...
import com.amogus.leetcode.arrays.tasks.BuildArrayFromPermutation;
 ...
 *     = [4,5,0,1,2,3]
 */
public class BuildArrayFromPermutationBruteForce implements BuildArrayFromPermutation {
    @Override
