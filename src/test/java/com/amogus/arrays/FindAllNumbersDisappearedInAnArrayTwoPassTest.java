...
import com.amogus.leetcode.arrays.impl.pass.two.FindAllNumbersDisappearedInAnArrayTwoPass;
...
class FindAllNumbersDisappearedInAnArrayTwoPassTest {

    private FindAllNumbersDisappearedInAnArrayTwoPass underTest;

    @BeforeEach
    public void init() {
        underTest = new FindAllNumbersDisappearedInAnArrayTwoPass();
    }
